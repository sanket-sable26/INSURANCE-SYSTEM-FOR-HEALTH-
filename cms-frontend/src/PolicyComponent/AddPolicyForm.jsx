                  ...
                  <form className="text-color">
                    <div className="mb-3">
                      ...
                      >
                        ...
                        <option value="Daycare Treatment">
                          Daycare Treatment
                        </option>
                        <option value="Maternity">Maternity</option>
                        <option value="Newborn Cover">
                          Newborn Cover
                        </option>
                        <option value="Ambulance Charges">
                          Ambulance Charges
                        </option>
                        ...
                        <option value="Restore Benefit">Restore Benefit</option>
                        <option value="No-Claim Bonus">No-Claim Bonus</option>
                        <option value="Preventive Health Check-up">Preventive Health Check-up</option>
                        <option value="Wellness Benefits">Wellness Benefits</option>
                        <option value="HealthReturns">HealthReturns</option>
                      </select>
                    </div>
                    <div className="mb-3">
                      <label for="description" class="form-label">
